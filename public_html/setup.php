<?php 
	...
	$sql7 = "create table teacher(t_name varchar(200), t_uid varchar(50) primary key , t_pwd varchar(20) , t_phone bigint(15) , t_add text , t_subject text , t_quali text , t_bio text , t_pic text );";
	$conn->query($sql7);
