...
?>
<form method="post" class="rvs-paper-form">
	<input type="text" name="pid" value="rvs-paper" style="display: none;">
	...
	<input type="submit" name="submit" value="submit" class="btn btn-default rvs-paper-form submit">
</form>
