...
<?php
	...
	$sql = "SELECT * FROM pages where pid = 'exam-govt'";
	$result = $conn->query($sql);
	$row = $result->fetch_assoc();
?>
<h3 align="center">Government Job Vaccancy</h3>
<form method="post" class="exam-govt-form">
	<input type="text" name="pid" value="exam-govt" style="display: none;">
	...
	<input type="submit" name="submit" value="submit" class="btn btn-default exam-govt-form submit">
</form>
