<?php
	...
	$sql = "SELECT * FROM pages where pid = 'imp-question'";
	$result = $conn->query($sql);
	$row = $result->fetch_assoc();
?>
<form method="post" class="imp-question-form">
	<input type="text" name="pid" value="imp-question" style="display: none;">
	...
	<input type="submit" name="submit" value="submit" class="btn btn-default imp-question-form submit">
</form>
