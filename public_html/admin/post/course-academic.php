<?php
	...
	$sql = "SELECT * FROM pages where pid = 'course-academic'";
	$result = $conn->query($sql);
	$row = $result->fetch_assoc();
?>
<h3 align="center">Academic Courses</h3>
<form method="post" class="course-academic-form">
	<input type="text" name="pid" value="course-academic" style="display: none;">
	...
	<input type="submit" name="submit" value="submit" class="btn btn-default course-academic-form submit">
</form>
...
$(".course-academic-form").submit(function(e) {
