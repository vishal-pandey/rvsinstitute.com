...
<form method="post" class="about-rvs-form">
	...
	<textarea name="content" class="form-control textareaa" rows="20" placeholder="Content of the page. Here You can use the html tags and css to style and modify the page"><?php echo $row['content'];?></textarea>
