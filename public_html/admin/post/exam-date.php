...
<?php
	...
	$sql = "SELECT * FROM pages where pid = 'exam-date'";
	$result = $conn->query($sql);
	$row = $result->fetch_assoc();
?>
<h3 align="center">Examination Date</h3>
<form method="post" class="exam-date-form">
	<input type="text" name="pid" value="exam-date" style="display: none;">
	...
	<input type="submit" name="submit" value="submit" class="btn btn-default exam-date-form submit">
</form>
