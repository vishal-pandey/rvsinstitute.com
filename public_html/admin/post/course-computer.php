...
<?php
	...
	$sql = "SELECT * FROM pages where pid = 'course-computer'";
	$result = $conn->query($sql);
	$row = $result->fetch_assoc();
?>
<h3 align="center">Computer Courses</h3>
<form method="post" class="course-computer-form">
	<input type="text" name="pid" value="course-computer" style="display: none;">
	...
	<input type="submit" name="submit" value="submit" class="btn btn-default course-computer-form submit">
</form>
...
$(".course-computer-form").submit(function(e) {
