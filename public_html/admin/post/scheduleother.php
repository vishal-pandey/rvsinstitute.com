...
<?php
	...
	$sql = "SELECT * FROM pages where pid = 'other-schedule'";
	$result = $conn->query($sql);
	$row = $result->fetch_assoc();
?>
<form method="post" class="other-schedule-form">
	<input type="text" name="pid" value="other-schedule" style="display: none;">
	...
	<input type="submit" name="submit" value="submit" class="btn btn-default other-schedule-form submit">
</form>
