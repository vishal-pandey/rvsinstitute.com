<?php
	...
	$sql = "SELECT * FROM pages where pid = 'cbse-paper'";
	$result = $conn->query($sql);
	$row = $result->fetch_assoc();
?>
<form method="post" class="cbse-paper-form">
	<input type="text" name="pid" value="cbse-paper" style="display: none;">
	...
	<input type="submit" name="submit" value="submit" class="btn btn-default cbse-paper-form submit">
</form>
