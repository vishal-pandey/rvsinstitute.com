...
<?php
	...
	$sql = "SELECT * FROM pages where pid = 'exam-topper'";
	$result = $conn->query($sql);
	$row = $result->fetch_assoc();
?>
<h3 align="center">Topper Of The Examination</h3>
<form method="post" class="exam-topper-form">
	<input type="text" name="pid" value="exam-topper" style="display: none;">
	...
	<input type="submit" name="submit" value="submit" class="btn btn-default exam-topper-form submit">
</form>
