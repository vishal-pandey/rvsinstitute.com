...
<?php
	...
	$sql = "SELECT * FROM pages where pid = 'upcoming-batches'";
	$result = $conn->query($sql);
	$row = $result->fetch_assoc();
?>
<form method="post" class="upcoming-batches-form">
	<input type="text" name="pid" value="upcoming-batches" style="display: none;">
	...
	<input type="submit" name="submit" value="submit" class="btn btn-default upcoming-batches-form submit">
</form>
