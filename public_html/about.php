...
<form>
  <div class="form-group">
    <label for="exampleInputEmail1">Email address <i class="fa fa-user-o" aria-hidden="true"></i></label>
...
?>
<?php // About - From the pen of Manageing Director
  if(isset($_GET['FromMD'])){
    $Content = 'This is MD&apos;s Message';
  } else {
    echo 'No Subpage Selected';
  }
?>
<!DOCTYPE html>
<html lang="en">
